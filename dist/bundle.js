...
var _parseInt = __webpack_require__(163);
...
var _events = __webpack_require__(156);
...
function registerEventHandlers() {
    (0, _events.listen)('submit', '#formList', function (event) {
...
var _getIterator2 = __webpack_require__(161);
...
var _feature = __webpack_require__(157);
...
function renderCheckItem(todo) {

    return '<li class="done list-group-item">\n        <input class="js_toggle_todo" type="checkbox" data-id="' + todo.id + '"' + (todo.done ? ' checked' : '') + '>\n        ' + todo.text + '\n    </li>';
}
...
module.exports = !__webpack_require__(55) && !__webpack_require__(57)(function () {
...
// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
__webpack_require__(49)(IteratorPrototype, __webpack_require__(44)('iterator'), function () { return this; });
